...
<body>
<form action="save"  style="width:400px; margin:auto;" method="get">
    ...
    <br>
        <input class="btn btn-primary" type="submit" value="Submit"  button onclick="document.writeln('Multumim pentru raspunsuri si timpul acordat!')" style="
    font-size: larger;
